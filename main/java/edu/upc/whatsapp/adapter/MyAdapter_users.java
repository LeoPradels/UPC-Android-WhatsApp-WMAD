...
public class MyAdapter_users extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      if (convertView == null) {
        ...
        TextView tvName = (TextView) convertView.findViewById(R.id.row_twotextviews_name);
        TextView tvSurname = (TextView) convertView.findViewById(R.id.row_twotextviews_surname);
